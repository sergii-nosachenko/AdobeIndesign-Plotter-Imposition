...
LANG['en_US'] = {
    ...
    values: {
        ...
        'Circle Filename Disclaimer': 'CIRCLES: File name must contains: _D={1}, where {1} - diameter in mm.',
        'Diameter Label': 'Diameter',
        'Diameter Tip': 'Diameter must be a number > 0',
        'Rectangles': 'Rectangles',
        'Rectangles Settings Panel Title': 'Rectangles settings',
        'Rectangles Filename Disclaimer': 'RECTANGLES: File name must contains: _{1}x{2} R={3}, where {1} - width, {2} - height, {3} - fillet radius in mm. Width and height are required.',
        'Width Label': 'Width',
