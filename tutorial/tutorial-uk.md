...
Я не вказав зовнішній файл з мітками, оскільки задав параметри міток вручну. Але ви можете використовувати завчасно підготовлений файл з оптичними мітками вашого плотера. Головне, щоб розміри листа та полів співпадали з налаштуваннями обраного плотера.
...
Після того, як ми [створили новий плотер](#приклад-додавання-нового-плотера), закриваємо вікно редактора.
