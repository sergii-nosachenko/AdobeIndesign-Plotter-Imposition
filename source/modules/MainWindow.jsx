...
function DialogWindow() {
  ...
  // Перевіряємо наявність нової версії (додаємо поточний штамп часу, щоб уникнинути кешування запиту)
  loadUrl(PACKAGE_URL + '?' + Math.round(new Date().getTime() / 1000).toString(), checkNewVersionDone);
