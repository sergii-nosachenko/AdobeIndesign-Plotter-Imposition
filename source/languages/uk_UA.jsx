...
LANG['uk_UA'] = {
    ...
    values: {
        ...
        'Circle Filename Disclaimer': 'КОЛА: Назва має містити: _D={1}, де {1} - діаметр в мм.',
        ...
        'Rectangles Filename Disclaimer': 'ПРЯМОКУТНИКИ: Назва має містити: _{1}x{2} R={3}, де {1} - ширина в мм, {2} - висота в мм, {3} - радіус скругління в мм. Обов\'язкові лише ширина та висота.',
        'Width Label': 'Ширина',
