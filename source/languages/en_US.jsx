...
LANG['en_US'] = {
    ...
    title: 'English',
    values: {
        'Plugin Title': 'Imposition for plotter cutting | %version%',
        ...
        'Circle Filename Disclaimer': 'CIRCLES: File name must contains string in brackets:\n[ D={1} ({2}) ], where {1} = cut diameter in mm, {2} = contour gap in mm (optional)',
        'Diameter Label': 'Diameter',
        'Diameter Tip': 'Diameter must be a number > 0',
        'Rectangles': 'Rectangles',
        'Rectangles Settings Panel Title': 'Rectangles settings',
        'Rectangles Filename Disclaimer': 'RECTANGLES: File name must contains string in brackets:\n[ {1}x{2} R={3} ({4}) ], where {1} = cut width in mm, {2} = cut height in mm, {3} = fillet radius in mm (optional), {4} = contour gap in mm (optional)',
        'Width Label': 'Width',
        ...
        'Confirm save msg': 'You have unsaved data. Save it?',
        ...
        'Error - Not correct size': 'Incorrect rectangle width or height',
